    ...
    <div class="container my-5">
      ...
      <div class="row mb-5">
        <div class="col-md-3 text-center py-2">
          <a href="approve_expenses.php" class="btn btn-block btn-warning"><span class="fa fa-pencil-square-o"></span> Pending Approvals <span class="badge badge-dark badge-pill"><?php no_of_approvals_pending() ?></span></a>
        </div>
