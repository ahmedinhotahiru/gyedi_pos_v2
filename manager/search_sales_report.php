                ...
                <div class="row">
                    ...
                    <?php
                        if(isset($_GET['search_date'])){
                            ...
                            if(no_of_checkouts2($search_date) < 1){
                                ...
                                $total_sales = number_format(total_sales2($search_date), 2);            
                                echo '<div class="col-md-12 mb-5">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                ...
                                sales_summary2($search_date);
                                $no_of_checkouts = no_of_checkouts2($search_date);       
                                ...
                                expenses_2($search_date);
                                $no_of_expenses = no_of_expenses2($search_date);
                                $total_expenditure = number_format(total_expenses2($search_date), 2);
                                ...
                                $total_balance = total_sales2($search_date) - total_expenses2($search_date);
                                $total_balance = number_format($total_balance, 2);
                                
                                echo '<div class="col text-center mb-5">
