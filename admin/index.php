...
<head>
  <meta charset="UTF-8">
  <meta type="description" content="Gyedi Enterprise official shop management system. Gyedi Enterprise..... your education, our concern...">
  <meta type="keyword" content="gyedi+enterprise+official+shop+management+system+print+scan+photocopy+online+registration+novdec+wassce+result+checker+card">
...
<body>
    ...
    <div class="container">
        ...
        <section id="overlay" class="py-5 px-4" style="border:1px solid #d3d2d2; border-radius: 10px;background:white;">
