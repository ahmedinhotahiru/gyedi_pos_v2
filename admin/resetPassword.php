        ...
        <div class="content text-center">
            ...
            <form class="p-4 px-5" action="resetPassword.php" method="GET">
                <div class="input-group">
                    <input type="text" name="username" id="username" placeholder="Enter username" class="form-control" size="40">
                </div><br>
                <p id="error"></p>
                            ...
                            if($user = mysqli_fetch_assoc($result)){
                                ...
                                if($username == $db_username){
                                    ...
                                    if(mail($receipient, $subject, $message, $headers)){
                                        ...
                                        $query = "UPDATE `admin` SET `password` = '$new_password' WHERE `users`.`user_id` = '$user_id'";
                                        $result = mysqli_query($db, $query);
