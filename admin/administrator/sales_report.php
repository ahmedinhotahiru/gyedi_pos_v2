                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-5">
                        <div class="card">
                            ...
                            <a href="<?php echo 'checkouts.php?&branch_id='.$branch_id; ?>"><span class="fa fa-angle-double-right"></span> Details</a>
                            </div>


                            <!-- Sales summary from database starts here -->
                            <?php
                                sales_summary($branch_id, $date);
                            ?>
                            <!-- Sales summary from database ends here -->
                            
                            <div class="card-footer d-flex justify-content-between">
                                <p>Total number of checkouts: <?php echo no_of_checkouts($branch_id, $date); ?></p>
                                <p>Total Sales: GH¢ <?php $total_sales = number_format(total_sales($branch_id, $date), 2); echo $total_sales; ?></p>
                            </div>
                    ...
                    <div class="col-md-12 mb-5">
                        <div class="card">
                            ...
                            <?php
                                expenses_today($branch_id, $date);
                            ?>
                            <!-- expenses ends here -->

                            <div class="card-footer d-flex justify-content-between">
                                <p>Total number of expenditure: <?php echo no_of_expenses($branch_id, $date); ?></p>
                                <p>Total Expenditure: GH¢ <?php $total_expenditure = number_format(total_expenses($branch_id, $date), 2); echo $total_expenditure; ?></p>
                            </div>
                    ...
                    <div class="col text-center text-white mb-5">
                        <?php $total_balance = total_sales($branch_id, $date) - total_expenses($branch_id, $date); ?>
