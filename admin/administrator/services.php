                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="list-group ">
                            ...
                            <a href="#" class="list-group-item list-group-item-action bg-light text-danger">
                                <span class="fa fa-globe"></span> Services <span class="badge bg-danger badge-pill badge-secondary pull-right"> <?php echo no_of_services(); ?></span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mt-5">
                        <a href="<?php echo u(h('add_service.php')); ?>" class="btn text-white btn-block mb-3"><span class="fa fa-plus"></span> Add service</a>
                        <a href="<?php echo u(h('remove_service.php')); ?>" class="btn text-warning btn-block mb-3"><span class="fa fa-trash"></span> Remove service</a>
                    </div>
                    <!-- Action buttons start here -->
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <p class="card-text"><span class="fa fa-globe"></span> Services</p>
                            </div>
