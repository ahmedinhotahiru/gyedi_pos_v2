    ...
    <div class="container my-5">
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-9">
                ...
                <div class="row mb-5">
                    <div class="col-12">
                    <form action='<?php echo "search_checkout.php"; ?>' method="get">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <p class="card-title"><span class="fa fa-shopping-cart"></span> Checkouts Today</p>
                            </div>


                            <!-- Card body starts here -->
                            <?php checkouts($branch_id, $date); ?>
                            <!-- Card body ends here -->
