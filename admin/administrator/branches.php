            ...
            <div class="col-md-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="list-group ">
                            ...
                            <a href="#" class="list-group-item list-group-item-action bg-light text-success">
                                <span class="fa fa-home"></span> Branches <span class="badge bg-success badge-pill badge-secondary pull-right"> <?php echo no_of_branches(); ?></span>
                            </a>
                    ...
                    <div class="col-md-12 mt-5">
                        <a href="<?php echo u(h('add_branch.php')); ?>" class="btn text-white btn-block mb-3"><span class="fa fa-plus"></span> Add branch</a>
                        <a href="<?php echo u(h('remove_branch.php')); ?>" class="btn text-warning btn-block mb-3"><span class="fa fa-trash"></span> Remove branch</a>
                    </div>
                    <!-- Action buttons start here -->
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <p class="card-text"><span class="fa fa-home"></span> Branches</p>
                            </div>
