    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item px-2 <?php if($page_title == 'Gyedi | Orders'){echo 'active';} ?>">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <!-- Cart -->
          <li class="nav-item px-2"><a href="#" class="nav-link" data-toggle="modal" data-target="#viewCartModal"><span class="fa fa-shopping-cart"></span> View Cart</a></li>
...
?>
  ...
  <header class="bg-light py-3 <?php if($page_title == 'Gyedi | Receipt'){echo 'header';} ?>">
    <div class="container d-flex justify-content-between">
      ...
      <!-- Profile picture -->
      <div class="dp">
        <a href="profile.php"><img src="<?php echo user_pic($_SESSION['user_id']); ?>" alt="" onerror="this.onerror=null;this.src='../img/profile.jpg';" class="flex-end"></a>
      </div>
    </div>
  </header>
  <!-- Header Ends here -->