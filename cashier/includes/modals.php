  ...
  <!-- Cancel Order Modal starts here -->
    <div class="modal fade" id="cancelOrderModal" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
          ...
          <form action="cancel_order.php" method="GET">
            ...
            <div class="modal-body">
              <div class="form">
                <!-- Display orders from database starts here -->
                <?php cancel_order_modal(); ?>
                <!-- Display orders from database starts here -->
  ...
  <!-- Cancel Order Modal ends here -->



  <!-- View Cart Modal starts here -->
    <div class="modal fade" id="viewCartModal" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog">
        <div class="modal-content">
          <!-- modal header starts here -->
              ...
              <div class="">
                <div class="row">
                  <div class="col-3 offset-3">
                    <button type="submit" name="logout" class="btn btn-primary btn-block">Yes</button>
                  </div>
                  <div class="col-3">
        ...
        <div class="modal-content">
          ...
          <form action="profile.php" method="POST">
            ...
            <div class="modal-footer">
                <button type="submit" name="change_password" class="btn btn-primary"><span class="fa fa-lock"></span> Change Password</button>
